...
cols = origdat2.select_dtypes(np.number).columns
origdat2[cols] = minmax_scale(origdat2[cols])
...
cols = origdat3.select_dtypes(np.number).columns
origdat3[cols] = minmax_scale(origdat3[cols])
