...
origdat2 = origdat2[['danceability', 'valence', 'duration_ms', 'popularity', 'top k']]
...
# the predictor variables are the remaining
# columns of the data set
Xdf2 = origdat2.iloc[:,:-1]
X2= dat2[:,:-1].astype('float')
...
origdat3 = origdat3[['danceability', 'valence', 'duration_ms', 'popularity', 'top k']]
...
# the predictor variables are the remaining
# columns of the data set
Xdf3 = origdat3.iloc[:,:-1]
X3= dat3[:,:-1].astype('float')
